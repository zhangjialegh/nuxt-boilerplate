  ...
  <main class="row content__page">
    <article class="column large-full entry format-standard">
      <div class="article-main-content">
        ...
        <div class="entry__post-thumb">
          <img
            ...
            srcset="images/thumbs/single/standard/standard-2000.jpg 2000w, images/thumbs/single/standard/standard-1000.jpg 1000w, images/thumbs/single/standard/standard-500.jpg 500w"
      ...
      <div class="content__page-header entry__header">
        <h1 class="display-1 entry__title">This Is A Standard Format Post.</h1>
      ...
      <div class="entry__content">
        ...
        <p>
          ...
          <a
            href="http://#"
          >omnis voluptas assumenda est</a> id quod maxime placeat
...
export default {
  ...
  mounted() {
    const vm = this
    const imgDoms = document.querySelectorAll('.article-main-content img')
    Array.from(imgDoms).forEach((ele, index) => {
      vm.imgs.push(ele.src)
      ele.addEventListener('click', vm.showImg.bind(vm, index))
    });
    this.$bus.$emit('imgs', {
      imgs: vm.imgs
    })
  ...
  beforeDestroy() {
    const vm = this
    const imgDoms = document.querySelectorAll('.article-main-content img')
    Array.from(imgDoms).forEach(ele => {
      ele.removeEventListener('click', vm.showImg)
    });
  },
  methods: {
    showImg (index) {
